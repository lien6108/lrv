...
function updateFilterBadge() {
  const ids = ["f-district","f-building-type","f-year-from","f-month-from","f-year-to","f-month-to","f-community",
...
function clearFilters() {
  ...
  ["f-year-from", "f-month-from", "f-year-to", "f-month-to", "f-community",
   "f-min-price", "f-max-price", "f-min-unit", "f-max-unit",
   "f-bedrooms", "f-bathrooms"].forEach(id => {
