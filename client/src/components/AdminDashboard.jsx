        ...
        <div id="users" className="glass-panel" style={{ scrollMarginTop: '2rem' }}>
          ...
          <form onSubmit={handleAddUser}>
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '1rem' }}>
              ...
              <input style={{ flex: 1, minWidth: '150px' }} type="number" placeholder="抽籤順序 (數字越小越先)" value={newUser.order_index} onChange={e => setNewUser({ ...newUser, order_index: e.target.value })} required />
